...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Mehfooz-ur-Rehman, a full-stack product developer building web, mobile, desktop and AI-powered business systems.',
  ...
  openGraph: {
    title: 'Mehfooz-ur-Rehman | Full-stack Product Developer',
    description: 'Web, mobile, desktop, dashboards, automation and AI-powered business systems.',
  ...
  twitter: {
    ...
    title: 'Mehfooz-ur-Rehman | Full-stack Product Developer',
    description: 'Full-stack product developer building web, mobile, desktop and AI-powered business systems.',
    images: ['/pic.webp'],
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${nunito.variable} ${jetbrainsMono.variable} h-full bg-[var(--color-page)] antialiased`}>
      <head>
      ...
      <body className="flex min-h-full flex-col bg-[var(--color-page)] font-[family-name:var(--font-nunito)] text-[var(--color-text)]">
        ...
        <Script async data-collect-dnt="true" src="https://scripts.simpleanalyticscdn.com/latest.js" strategy="afterInteractive" />
        <noscript>
