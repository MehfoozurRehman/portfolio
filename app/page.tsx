import { ArrowDown, ArrowRight, ArrowUpRight, Code2, GraduationCap, Mail, MapPin, MessageCircle, Phone } from 'lucide-react';
...
const eyebrow = 'inline-flex items-center gap-2 font-mono-label text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-[var(--color-accent)]';
const display = 'font-[family-name:var(--font-nunito)] font-extrabold leading-[0.98] tracking-[-0.01em]';
...
function SectionMarker({ index, label }: { index: string; label: string }) {
  return (
    <div className="mb-8 flex items-center gap-3">
      <span className="font-mono-label text-[0.68rem] font-semibold tracking-[0.2em] text-[var(--color-soft)]">{index}</span>
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[var(--color-page)] text-[var(--color-text)]">
      ...
      <section id="top" className="relative flex min-h-svh flex-col overflow-hidden pt-28 sm:pt-32">
        <div className="halo -left-[10%] -top-[10%] h-[40rem] w-[40rem]" style={{ background: 'var(--halo-a)' }} />
        <div className="halo -right-[8%] top-[20%] h-[32rem] w-[32rem]" style={{ background: 'var(--halo-b)' }} />
        <div
        ...
        <div className={`${shell} relative z-10 flex flex-1 flex-col justify-center`}>
          <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-10">
            <div>
              ...
              <Reveal delay={60}>
                <h1 className={`${display} mt-6 text-[clamp(2.1rem,5.6vw,4.3rem)]`}>
                  Products built
                  <br />
                  from{' '}
                  <span className="relative whitespace-nowrap text-[var(--color-accent)]">
                    idea
                    <svg className="absolute -bottom-0.5 left-0 w-full" viewBox="0 0 200 12" fill="none" preserveAspectRatio="none" aria-hidden="true">
                      <path d="M2 8c40-6 158-6 196 0" stroke="var(--color-accent)" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                  </span>{' '}
                  to launch.
                </h1>
              ...
              <Reveal delay={120}>
                <p className="mt-7 max-w-[36rem] text-[1rem] leading-8 text-[var(--color-muted)] sm:text-[1.06rem]">
                  I&apos;m <span className="font-bold text-[var(--color-text)]">Mehfooz-ur-Rehman</span> — a full-stack product developer shipping web, mobile, desktop, AI and automation systems that
              ...
              <Reveal delay={240}>
                <div className="mt-11 grid max-w-[34rem] grid-cols-3 gap-4 border-t border-[var(--border-subtle)] pt-6">
                  {[
                    ...
                    <div key={label}>
                      <div className={`${display} text-[clamp(1.3rem,2.4vw,1.9rem)]`}>{value}</div>
                      <div className="mt-1 font-mono-label text-[0.62rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-soft)]">{label}</div>
                    </div>
                  ))}
                </div>
              </Reveal>
              ...
              <div className="relative">
                ...
                <div className="overflow-hidden rounded-[1.7rem] border border-[var(--border-card)] bg-[var(--color-raise)] shadow-[0_30px_80px_-40px_var(--shadow-strong)]">
                  <div className="relative aspect-[4/5] w-full overflow-hidden">
                    <Image src="/pic.webp" alt="Mehfooz-ur-Rehman" fill className="object-cover object-center" sizes="(max-width: 1024px) 90vw, 420px" priority />
                    <div className="absolute inset-x-0 bottom-0 h-2/5 bg-gradient-to-t from-black/55 to-transparent" />
                    <div className="absolute inset-x-4 bottom-4 flex items-center justify-between">
                      <div>
                        <div className="font-mono-label text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-white/70">{profile.role}</div>
                        <div className="mt-0.5 text-[0.95rem] font-extrabold text-white">Web · Mobile · AI</div>
                      </div>
                      <a
                        href="#work"
                ...
                <div className="absolute -left-4 top-8 hidden rounded-2xl border border-[var(--border-card)] bg-[var(--color-page-soft)]/90 px-3.5 py-2.5 shadow-lg shadow-[color:var(--shadow-ambient)] backdrop-blur-md sm:block">
                  <div className="font-mono-label text-[0.58rem] font-semibold uppercase tracking-[0.16em] text-[var(--color-soft)]">Stack</div>
                  <div className="text-[0.82rem] font-bold text-[var(--color-text)]">Next · Convex · AI</div>
                </div>
                <div className="absolute -right-3 bottom-16 hidden items-center gap-2 rounded-2xl border border-[var(--border-card)] bg-[var(--color-page-soft)]/90 px-3.5 py-2.5 shadow-lg shadow-[color:var(--shadow-ambient)] backdrop-blur-md sm:flex">
                  ...
                  <span className="text-[0.78rem] font-bold text-[var(--color-text)]">Faisalabad, PK</span>
                </div>
              </div>
            </Reveal>
          </div>
        ...
        <div className="marquee-wrap marquee-mask relative z-10 mt-12 overflow-hidden border-y border-[var(--border-subtle)] bg-[var(--color-page-soft)] py-4 sm:mt-16">
          <div className="marquee-track">
            {[...stack, ...stack].map((item, i) => (
              <span key={`${item}-${i}`} className="flex items-center gap-6 pr-6 font-mono-label text-[0.9rem] font-semibold uppercase tracking-[0.12em] text-[var(--color-muted)]">
                {item}
      ...
      <section id="about" className={`${shell} py-14 sm:py-20`}>
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <Reveal>
            ...
            <h2 className={`${display} text-[clamp(1.55rem,2.9vw,2.35rem)]`}>A product developer with real, practical range.</h2>
            <p className="mt-6 text-[0.98rem] leading-8 text-[var(--color-muted)]">{profile.about}</p>
            <p className="mt-4 text-[0.98rem] leading-8 text-[var(--color-muted)]">{profile.subheadline}</p>
          </Reveal>

          <div className="grid gap-3 sm:grid-cols-2">
            {profileHighlights.map((item, i) => (
              <Reveal key={item.title} delay={i * 70} as="article" className="card-hover flex flex-col rounded-2xl border border-[var(--border-card)] bg-[var(--color-raise)] p-6">
                <span className="grid size-11 place-items-center rounded-xl bg-[var(--color-accent)]/10 text-[var(--color-accent)]">
                  <item.icon size={22} aria-hidden="true" />
                </span>
                <h3 className="mt-5 text-[1.05rem] font-extrabold leading-tight">{item.title}</h3>
                <p className="mt-2 text-[0.9rem] leading-7 text-[var(--color-muted)]">{item.text}</p>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <section id="services" className="border-y border-[var(--border-subtle)] bg-[var(--color-page-soft)]">
        <div className={`${shell} py-14 sm:py-20`}>
          <Reveal>
            <SectionMarker index="02" label="What I build" />
            <div className="grid gap-6 lg:grid-cols-[1fr_1fr] lg:items-end">
              <h2 className={`${display} text-[clamp(1.55rem,2.9vw,2.35rem)]`}>Complete business systems, not isolated screens.</h2>
              <p className="text-[0.96rem] leading-8 text-[var(--color-muted)]">
                I build the workflows around the screen too: data, roles, automation, integrations and the launch details that make software actually usable.
              </p>
            </div>
          </Reveal>
          ...
          <div className="mt-12 divide-y divide-[var(--border-subtle)] border-t border-[var(--border-subtle)]">
            {services.map((service, i) => (
              <Reveal key={service.title} as="article" className="group grid grid-cols-[auto_1fr] items-start gap-5 py-7 transition sm:grid-cols-[auto_0.4fr_1fr] sm:items-center sm:gap-8">
                <span className="font-mono-label text-[0.72rem] font-semibold text-[var(--color-soft)]">0{i + 1}</span>
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="text-[1.2rem] font-extrabold leading-tight transition group-hover:text-[var(--color-accent)]">{service.title}</h3>
                </div>
                <p className="col-span-2 text-[0.92rem] leading-7 text-[var(--color-muted)] sm:col-span-1">{service.description}</p>
              </Reveal>
            ))}
          </div>
        </div>
      ...
      <section id="work" className={`${shell} py-14 sm:py-20`}>
        <Reveal>
          ...
          <h2 className={`${display} max-w-2xl text-[clamp(1.55rem,2.9vw,2.35rem)]`}>Products shaped around operations, revenue and daily use.</h2>
        </Reveal>
          ...
          {projects.map((project, i) => {
            ...
            return (
              <Reveal
                ...
                delay={(i % 3) * 60}
                as="article"
                className={`card-hover group flex flex-col overflow-hidden rounded-2xl border border-[var(--border-card)] bg-[var(--color-raise)] ${featured ? 'md:col-span-1 xl:col-span-1' : ''}`}
              >
                {project.heroImageUrl ? (
                  ...
                  <div className="relative flex aspect-[16/10] w-full items-center justify-center overflow-hidden bg-gradient-to-br from-[var(--color-accent)]/12 to-[var(--color-accent-2)]/10">
                    <project.icon size={44} className="text-[var(--color-accent)] opacity-80" aria-hidden="true" />
                  </div>
                )}
                  ...
                  <div className="mb-3 flex items-center gap-2.5">
                    {logo ? (
                      <span className="grid size-8 shrink-0 place-items-center overflow-hidden rounded-lg border border-[var(--border-subtle)] bg-[var(--color-page)]">
                        <Image src={logo} alt="" width={24} height={24} className="size-5 object-contain" aria-hidden="true" />
                      </span>
                    ) : null}
                    <span className="font-mono-label text-[0.6rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-soft)]">{project.category}</span>
                  </div>

                  <h3 className="text-[1.25rem] font-extrabold leading-tight">{project.title}</h3>
                  <p className="mt-2.5 text-[0.88rem] leading-7 text-[var(--color-muted)]">{project.summary}</p>
      ...
      <section id="experience" className="border-y border-[var(--border-subtle)] bg-[var(--color-page-soft)]">
        <div className={`${shell} py-14 sm:py-20`}>
          <Reveal>
            <SectionMarker index="04" label="Experience" />
            <h2 className={`${display} max-w-2xl text-[clamp(1.55rem,2.9vw,2.35rem)]`}>Work across schools, SaaS teams and business systems.</h2>
          </Reveal>

          <div className="mt-12 border-l border-[var(--border-card)] pl-6 sm:pl-8">
            {experience.map((item, i) => (
              <Reveal key={`${item.company}-${item.period}`} as="article" delay={i * 50} className="relative pb-10 last:pb-0">
                ...
                <div className="font-mono-label text-[0.66rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-accent)]">{item.period}</div>
                <h3 className="mt-2 text-[1.2rem] font-extrabold leading-tight">{item.role}</h3>
                <p className="mt-1 text-[0.92rem] font-bold text-[var(--color-soft)]">
                  {item.company} · {item.location}
                </p>
                <p className="mt-3 max-w-2xl text-[0.92rem] leading-7 text-[var(--color-muted)]">{item.summary}</p>
                <div className="mt-4 flex flex-wrap gap-1.5">
      ...
      <section className={`${shell} py-14 sm:py-20`}>
        <Reveal>
          ...
          <h2 className={`${display} max-w-2xl text-[clamp(1.55rem,2.9vw,2.35rem)]`}>A direct path from workflow to working software.</h2>
        </Reveal>
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {process.map((item, i) => (
            <Reveal key={item.title} delay={i * 70} as="article" className="card-hover relative overflow-hidden rounded-2xl border border-[var(--border-card)] bg-[var(--color-raise)] p-6">
              <span className={`${display} absolute -right-2 -top-3 text-[5rem] text-[var(--color-text)] opacity-[0.05]`}>{i + 1}</span>
              <span className="grid size-11 place-items-center rounded-xl bg-[var(--color-accent)]/10 text-[var(--color-accent)]">
                <item.icon size={22} aria-hidden="true" />
              </span>
              <h3 className="mt-5 text-[1.1rem] font-extrabold leading-tight">{item.title}</h3>
              <p className="mt-2 text-[0.9rem] leading-7 text-[var(--color-muted)]">{item.text}</p>
            </Reveal>
          ))}
        </div>
      ...
      <section className="border-t border-[var(--border-subtle)] bg-[var(--color-page-soft)]">
        <div className={`${shell} grid gap-12 py-14 sm:py-20 lg:grid-cols-2 lg:gap-16`}>
          <Reveal>
            ...
            {education.map((item) => (
              <article key={item.school} className="rounded-2xl border border-[var(--border-card)] bg-[var(--color-raise)] p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[1.12rem] font-extrabold leading-tight">{item.school}</h3>
                    <p className="mt-1 text-[0.9rem] text-[var(--color-muted)]">{item.degree}</p>
                    <p className="mt-2 font-mono-label text-[0.66rem] font-semibold uppercase tracking-[0.14em] text-[var(--color-accent)]">{item.period}</p>
                  </div>
                </div>
                <div className="mt-5 flex flex-wrap gap-1.5">
                  {item.focus.map((f) => (
                    <span key={f} className="rounded-md border border-[var(--border-subtle)] bg-[var(--color-page)] px-2.5 py-1 font-mono-label text-[0.64rem] font-semibold text-[var(--color-muted)]">
                      {f}
                    </span>
                  ))}
                </div>
          ...
          <Reveal delay={80}>
            ...
            <h3 className={`${display} text-[1.4rem]`}>Modern tools I already use to ship.</h3>
      ...
      <section className={`${shell} py-14 sm:py-20`}>
        <Reveal>
          ...
          <h2 className={`${display} max-w-2xl text-[clamp(1.55rem,2.9vw,2.35rem)]`}>What clients and teammates already say.</h2>
        </Reveal>
        <div className="mt-12 grid gap-4 lg:grid-cols-3">
          {testimonials.map((t, i) => (
            <Reveal key={t.name} delay={i * 70} as="blockquote" className="card-hover flex flex-col rounded-2xl border border-[var(--border-card)] bg-[var(--color-raise)] p-6">
              <span className={`${display} text-[3rem] leading-none text-[var(--color-accent)]/30`}>&ldquo;</span>
              <p className="-mt-3 text-[1.02rem] font-bold leading-8 text-[var(--color-text)]">{t.quote}</p>
              <footer className="mt-6 flex items-center gap-3 border-t border-[var(--border-subtle)] pt-5">
                <span className="grid size-10 place-items-center rounded-full bg-[var(--color-accent)]/12 font-extrabold text-[var(--color-accent)]">{t.name.charAt(0)}</span>
                <span>
                  <span className="block text-[0.9rem] font-extrabold">{t.name}</span>
                  <span className="block text-[0.8rem] text-[var(--color-muted)]">{t.role}</span>
                </span>
              </footer>
            </Reveal>
          ))}
      ...
      <section id="contact" className="relative overflow-hidden border-t border-[var(--border-subtle)] bg-[var(--color-page-soft)]">
        <div className="halo -bottom-[20%] left-[10%] h-[30rem] w-[30rem]" style={{ background: 'var(--halo-a)' }} />
        <div className={`${shell} relative z-10 grid items-center gap-12 py-14 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16`}>
          <Reveal>
            ...
            <h2 className={`${display} text-[clamp(1.7rem,3.1vw,2.55rem)]`}>Need a reliable developer to build your product?</h2>
            <p className="mt-6 max-w-xl text-[0.98rem] leading-8 text-[var(--color-muted)]">
              Send the workflow, product idea or stuck project. I&apos;m strongest when the job needs product thinking, full-stack execution and a practical launch path.
            </p>
            ...
            <div className="mt-8 grid gap-2.5">
              {[
                ...
                >
                  ...
                  {row.label}
                  <ArrowUpRight size={15} className="ml-auto text-[var(--color-soft)]" aria-hidden="true" />
                </a>
              ))}
            </div>
      ...
      <footer className="border-t border-[var(--border-hairline)] bg-[var(--color-page)]">
        <div className={`${shell} py-8`}>
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="font-mono-label text-[0.68rem] font-semibold uppercase tracking-[0.12em] text-[var(--color-soft)]">Portfolio versions</p>
