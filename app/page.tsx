    ...
    <>
      <section id="home__section" className="home__section">
        ...
        <button
          ...
          onClick={() => {
            const elementSection = document.getElementById("work__section");
            if (elementSection) {
              elementSection.scrollIntoView();
            }
            const element = document.getElementById("work") as HTMLInputElement;
            if (element) {
