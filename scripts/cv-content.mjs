export const cvContent = {
  ...
  profileHighlights: [
    [
      ...
      "Comfortable across frontend, backend, mobile, desktop, automation and deployment.",
    ],
    [
      "Business workflow focus",
      "Builds around real operations: fees, attendance, invoices, leads, dashboards and reporting.",
    ],
    [
      "Product communication",
      "Strong fit for teams that need clear implementation, UI judgment and practical delivery.",
    ],
    [
      "Reliable daily software",
      "Experience on systems where parents, schools, customers and internal teams use the product every day.",
    ],
  ],
  experience: [
    [
