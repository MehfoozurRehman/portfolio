import { aida, barry, dsmeglobal } from "../assets";
...
export const works = [
  ...
  },
  {
    ...
    banner: barry,
    info: "A dashboard for a food flavor manufacturer to manage their inventory and sales and purchase orders and manage their employees and their salaries and attendance and much more",
    siteLink: "https://erp.advancedff.com/",
  },
];
