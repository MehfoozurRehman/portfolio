...
export default function HomeTestimonials() {
  ...
  const [testimonialSlidesPerView, setTestimonialSlidesPerView] = useState(2);

  function changeTestimonialSlidesPerView() {
    const windowWidth = window.innerWidth;

    if (windowWidth < 700) {
      setTestimonialSlidesPerView(1);
      setIsMobile(true);
    } else if (windowWidth < 1000) {
      setTestimonialSlidesPerView(1.5);
      setIsMobile(true);
    } else {
      setTestimonialSlidesPerView(2);
      setIsMobile(false);
    }
  }
