import { Bot, BrainCircuit, BriefcaseBusiness, Building2, Code2, Laptop, Map, MessageCircle, MonitorCog, MousePointerClick, Rocket, School, Smartphone, UsersRound } from 'lucide-react';
...
export const profile = {
  ...
  subheadline: 'I help businesses turn messy operations into fast, reliable software: dashboards, mobile apps, automation, AI assistants, WhatsApp workflows and complete SaaS products.',
  about:
...
export const services: Service[] = [
  {
    ...
    description: 'Admin panels, customer portals, analytics, billing flows and operations software built around real business workflows.',
  },
  {
    title: 'Mobile apps',
    icon: Smartphone,
    description: 'React Native and Expo apps for iOS and Android, including EAS builds, TestFlight and Play Console delivery.',
  },
  {
    title: 'AI automation',
    icon: BrainCircuit,
    description: 'OpenAI and Gemini powered assistants, summaries, action items, business chat, and workflow automation.',
  },
  {
    title: 'Desktop tools',
    icon: MonitorCog,
    description: 'Electron and background utilities that connect local desktop workflows with cloud dashboards.',
  },
];
  ...
  */
  {
    ...
    summary: 'A company site for a custom technology services firm focused on web and mobile development, scoping workshops, UI/UX and turnkey product delivery.',
    businessValue: 'Shows the delivery side of the product work with a company profile centered on end-to-end software services.',
  ...
  },
  {
    ...
    summary: 'An Amazon seller platform that focuses on pricing, inventory, order tracking and analytics to keep operations and profitability visible.',
    businessValue: 'Turns marketplace operations into one dashboard so sellers can monitor performance without guesswork.',
  ...
  */
  {
    ...
    summary: 'Lead capture, confirmations, AI-assisted replies and business process automation around WhatsApp conversations.',
    businessValue: 'Designed for businesses in markets where customers already prefer WhatsApp over complex portals.',
  ...
  },
  {
    ...
    summary: 'Meeting join, caption capture, summary and action-item workflows using Microsoft Graph and AI services.',
    businessValue: 'Turns meetings into structured follow-ups instead of lost context and manual note taking.',
  ...
  },
  {
    ...
    summary: 'Production mobile apps shipped through Expo, EAS, TestFlight and Google Play Console.',
    businessValue: 'One codebase with practical native delivery for startups and internal business tools.',
  ...
  },
  {
    ...
    summary: 'Desktop utilities that run background workflows and connect local machines to web dashboards.',
    businessValue: 'Useful when the real workflow still depends on a user machine, files, browser sessions or local state.',
...
export const experience: Experience[] = [
  {
    ...
    summary: 'Working on company products and software-as-a-service projects that help businesses grow, simplify operations and improve internal workflows.',
  ...
  },
  {
    ...
    location: 'Samundri, Punjab, Pakistan · Hybrid',
    summary: 'Building a multi-school management product that helps schools sign up, pay monthly and manage daily work with clearer communication between parents and schools.',
  ...
  },
  {
    ...
    summary: 'Supported internal systems and strengthened practical full-stack skills while working with business-facing software.',
  ...
  },
  {
    ...
    summary: 'Built SaaS and digital identity projects for businesses that needed stronger reach, clearer product presence and revenue-focused systems.',
...
export const testimonials: Testimonial[] = [
  {
    quote: 'Mehfooz is very talented and has a great eye for design. He is very professional and always delivers on time.',
    name: 'Dayyan Shahid',
    role: 'CEO, Dsme Globals',
  },
  {
    quote: 'I have had the pleasure of working with Mehfooz for over two years, and he has been an indispensable asset to our team.',
    name: 'Hammad Habib',
    role: 'CEO, Devscot',
  },
  {
    quote: 'Mehfooz was very helpful from beginning to end. He quickly solved one of my React bugs and explained the misunderstanding clearly.',
    name: 'blackswanlrn',
    role: 'Fiverr client',
  },
];
